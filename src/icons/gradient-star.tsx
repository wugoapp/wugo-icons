  ...
  >
    <Defs>
      ...
      <RadialGradient
        ...
        cy={1.006}
        r={1.089}
        gradientTransform="matrix(0.952, 0, 0, -1, -0.251, 1.988)"
...
export const GradientStar = memo<IconProps>(themed(Icon));
